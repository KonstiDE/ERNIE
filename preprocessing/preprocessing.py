...
def clean(
    ...
    if stopwords:
        stopwords = list(stopwordsiso.stopwords(["ja", "en", "zh_Hant", "zh", "yue", "ru", "ind", "ko"])).extend(stopwords_custom)
        ...
        with tqdm(df["main_content"], total=num_docs) as t:
            for doc_text in t:
                ...
                if lang == "jpn" or lang == "zh" or lang == "zh_Hant" or lang == "yue":
                    ...
                    complete_doc.append(doc_text.split(" "))
